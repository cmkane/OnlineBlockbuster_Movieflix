package edu.uci.ics.kanec1.service.api_gateway.configs;
...
public class MovieConfigs {
    ...
    public MovieConfigs(ConfigsModel cm) throws NullPointerException {
        ...
        if (EPMovieGet == null) {
            ...
            if(EPMovieGet.contains("{")) {
                EPMovieGet = EPMovieGet.substring(0, EPMovieGet.indexOf('{')-1);
            }
        ...
        if (EPMovieDelete == null) {
            ...
            if(EPMovieDelete.contains("{")) {
                EPMovieDelete = EPMovieDelete.substring(0, EPMovieDelete.indexOf('{')-1);
            }
        ...
        if (EPGenreMovie == null) {
            ...
            if(EPGenreMovie.contains("{")) {
                EPGenreMovie = EPGenreMovie.substring(0, EPGenreMovie.indexOf('{')-1);
            }
        ...
        if (EPStarGet == null) {
            ...
            if(EPStarGet.contains("{")) {
                EPStarGet = EPStarGet.substring(0, EPStarGet.indexOf('{')-1);
            }
