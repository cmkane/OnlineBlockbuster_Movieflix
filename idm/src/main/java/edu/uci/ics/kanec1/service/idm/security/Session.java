package edu.uci.ics.kanec1.service.idm.security;
...
public class Session {
    public static final long SESSION_TIMEOUT = Idm.getConfigs().getTimeout();
    public static final long TOKEN_EXPR = Idm.getConfigs().getExpiration();
    ...
    public int isDataValid() {
        ...
        Timestamp nextTimeout = new Timestamp(currentTime.getTime() + SESSION_TIMEOUT);
        if(nextTimeout.after(exprTime)) {
            return 129;
        }
        return 130;
    }
